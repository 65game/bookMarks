<!--增加导入导出功能(白名单) 2017/3/31 lhw-->
<template>
    <section>
        <el-dialog :title="dialogTitle" v-model="dialogVisible" size="tiny">
            <!--上传区-->
            <!--/personblackwhite/person/white/import-->
            <!--https://jsonplaceholder.typicode.com/posts/-->
            <el-upload
                    class="h-upload"
                    ref="upload"
                    action="/dlbiz/risk/personblackwhite/person/white/import"
...
<script>
    ...
    export default {
        ...
        created(){
            this.$bus.$off('H_userWhite_uploadShow');
            this.$bus.$on('H_userWhite_uploadShow',(params)=>{
