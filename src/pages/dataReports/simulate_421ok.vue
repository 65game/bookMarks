	...
	<div class="box">
		<div v-if="reportStatus">
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" id="ruleForm">
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="现居住地">
							<el-input  placeholder="请输入现居住地"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="入学时间">
							<el-date-picker align="right" style="width: 100%;" v-model="value4" type="year" placeholder="请选择入学时间"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="毕业时间">
							<el-date-picker align="right" style="width: 100%;" v-model="value5" type="year" placeholder="请选择毕业时间"></el-date-picker>
						</el-form-item>
					</el-col>
				</el-row>
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="单位所在地">
							<el-input placeholder="请输入单位所在地"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="社保号">
							<el-input placeholder="请输入社保号"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
				...
				<!--经济资产情况-->
				<el-row>
					<h3 class="h-title">经济资产情况</h3>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="个人月收入">
							<el-input placeholder="请输入个人月收入" v-model="ruleForm.personalMonthlyIncome">
					...
					<el-col :span="12">
						<el-form-item label="配偶月收入">
							<el-input placeholder="请输入配偶月收入" v-model="ruleForm.spouseMonthlyAverageIncome">
								<template slot="append">元</template>
							</el-input>
						</el-form-item>
					</el-col>
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="家庭月支出">
							<el-input placeholder="请输入家庭月支出" v-model="ruleForm.input1">
								<template slot="append">元</template>
							</el-input>
						</el-form-item>
					</el-col>
				...
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="个人逾期金额">
							<el-input placeholder="请输入个人逾期金额" v-model="ruleForm.overdueAmount">
								<template slot="append">元</template>
							</el-input>
						</el-form-item>
					</el-col>
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="个贷逾期期数">
							<el-input placeholder="请输入个贷逾期期数" v-model="ruleForm.input10">
					...
					<el-col :span="12">
						<el-form-item label="正常还款期数">
							<el-input placeholder="请输入借款期限" v-model="ruleForm.input9">
								<template slot="append">期</template>
							</el-input>
						</el-form-item>
					</el-col>
				...
				<!--其他征信数据-->
				<h3 class="h-title">其他征信数据</h3>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="芝麻信用分">
							<el-input  auto-complete="off" placeholder="请输入芝麻信用分"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="同盾反欺诈分">
							<el-input  auto-complete="off" placeholder="请输入同盾反欺诈分"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="百融反欺诈分">
							<el-input  auto-complete="off" placeholder="请输入百融反欺诈分"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="百融信用分">
							<el-input  auto-complete="off" placeholder="请输入百融信用分"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row :gutter="20">
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="消费流水认证" >
							<el-input placeholder="请输入消费流水认证">
								<template slot="append">元</template>
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="通讯录联系人数量">
							<el-input  auto-complete="off" placeholder="请输入通讯录联系人数量"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
