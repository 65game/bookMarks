<!--wiki 更新产品评分指标--已发布  2017/3/30  PM lhw-->
<!--编辑指标分类界面--详情-->
<template>
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="指标分值" prop="score">
                        <el-input v-model="editForm.score" name="score" auto-complete="off" placeholder="请输入指标分值" :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="指标说明" prop="notes">
                        <el-input type="textarea" v-model="editForm.notes" placeholder="请输入指标说明" :disabled="true" resize="none"> </el-input>
                    </el-form-item>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        created(){
            this.$bus.$off('H_scoreSet_releaseInfo_DialogShow');
            this.$bus.$on('H_scoreSet_releaseInfo_DialogShow', (title,data) => {
